var L = {};
L.latLng = function() {}, window.markers = {}, $.i18n.init(i18noptions, function() {
	$.i18n.loadNamespace("v", function() {
		$.cachedScript("files/scripts/mapdata-hos_velen.js").done(function(a, e) {
			$.i18n.loadNamespace("g", function() {
				$.cachedScript("files/scripts/mapdata-gaunter.js").done(function(a, e) {
					$.i18n.loadNamespace("s", function() {
						$.cachedScript("files/scripts/mapdata-skellige.js").done(function(a, e) {
							$.i18n.loadNamespace("w", function() {
								$.cachedScript("files/scripts/mapdata-white_orchard.js").done(function(a, e) {
									$.i18n.loadNamespace("k", function() {
										$.cachedScript("files/scripts/mapdata-kaer_morhen.js").done(function(a, e) {
											$.i18n.loadNamespace("t", function() {
												$.cachedScript("files/scripts/mapdata-toussaint.js").done(function(a, e) {
													$.i18n.loadNamespace("f", function() {
														$.cachedScript("files/scripts/mapdata-fables.js").done(function(a, e) {
															$.i18n.loadNamespace("i", function() {
																$.cachedScript("files/scripts/mapdata-isle_mists.js").done(function(a, e) {
																	processData("velen", mapdata_hos_velen), processData("gaunter", mapdata_gaunter), processData("skellige", mapdata_skellige), processData("white_orchard", mapdata_white_orchard), processData("kaer_morhen", mapdata_kaer_morhen), processData("toussaint", mapdata_toussaint), processData("fables", mapdata_fables), processData("isle_mists", mapdata_isle_mists);
																	var t = $("#search");
																	t.keyup(function() {
																		doSearch()
																	}), t.val() && doSearch(), $("#clear").click(function() {
...
var count = 0,
	mapdata = [],
	processData = function(a, e) {
		var t = a.charAt(0);
		$.each(e, function(e, c) {
			$.each(c, function(e, c) {
				if (c && c.popup) {
					var s, n = window.location.href.replace(window.location.hash, "").toString().slice(0, -10) + t + "/index.html#3/" + c.coords[0][0] + "/" + c.coords[0][1] + "/m=" + c.coords[0][0] + "," + c.coords[0][1],
						o = c.popup.replace(/<\/?[^>]+(>|$)/g, ""),
						r = c.popupTitle ? c.popupTitle : "";
